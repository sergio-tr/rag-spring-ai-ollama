...
export default function LabRagEvalPage() {
  ...
  return (
    <div className="space-y-4">
      ...
      <p className="text-muted-foreground text-sm">{t("ragEvalHelp")}</p>

      <Card>
        <CardHeader>
          <CardTitle>{t("ragEvalTitle")}</CardTitle>
          <CardDescription>{t("ragEvalDescription")}</CardDescription>
        </CardHeader>
