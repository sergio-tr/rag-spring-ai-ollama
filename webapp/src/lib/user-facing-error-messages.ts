...
export const LAB_USER_ERROR_I18N_KEYS: Record<string, string> = {
  ...
  NO_ACTIVE_SNAPSHOT: "userError_NO_ACTIVE_SNAPSHOT",
  ...
  REINDEX_FAILED: "labRagSnapshotPreparationFailed",
  SNAPSHOT_PREPARATION_FAILED: "labRagSnapshotPreparationFailed",
...
export const USER_FACING_ERROR_MESSAGES_EN: Record<string, string> = {
  ...
  NO_DOCUMENTS: "The knowledge base has no documents. Upload at least one before evaluating.",
  KB_EMPTY: "The knowledge base has no documents. Upload at least one before evaluating.",
