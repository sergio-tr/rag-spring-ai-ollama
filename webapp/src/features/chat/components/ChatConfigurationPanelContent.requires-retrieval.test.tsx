  ...
  beforeEach(() => {
    useChatToolbarStore.setState({
      api: {
        ...
        conversationId: "c1",
        runtimeOverride: {},
        effectiveRuntimeConfig: { useRetrieval: false, rankerEnabled: false },
        effectiveRuntimeConfigLoading: false,
        effectiveRuntimeConfigError: null,
        refreshEffectiveRuntimeConfig: vi.fn(),
