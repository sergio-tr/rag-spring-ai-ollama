...
class MetadataGetDurationToolTest {
    ...
    private MetadataGetDurationTool tool;
    ...
    void setUp() {
        ...
        tool = new MetadataGetDurationTool(chatClient, retriever, extractor, llmCache);
    }

    @Test
    void execute_emptyRetrieval_returnsToolResult() {
        ToolResult result = tool.execute(ToolExecutionContext.of("duración", QueryType.GET_DURATION, null));
