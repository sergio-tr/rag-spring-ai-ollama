...
class ChatRuntimeUsesUserRetrievalDefaultsTest {

    @Test
    void mergedConversationConfig_includesPresetTopK() throws Exception {
        ...
        when(preset.getValues()).thenReturn(Map.of("topK", 5, "similarityThreshold", 0.9, "useAdvisor", true));
        ...
        assertEquals(true, terminal.get("useAdvisor").asBoolean());
