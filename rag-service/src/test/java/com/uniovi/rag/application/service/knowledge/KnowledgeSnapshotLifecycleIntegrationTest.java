...
class KnowledgeSnapshotLifecycleIntegrationTest {

    @Autowired private KnowledgeIndexSnapshotRepository knowledgeIndexSnapshotRepository;

    @Test
    void springContextLoads_withKnowledgeRepositories() {
        assertThat(knowledgeIndexSnapshotRepository.count()).isGreaterThanOrEqualTo(0L);
    }
}
