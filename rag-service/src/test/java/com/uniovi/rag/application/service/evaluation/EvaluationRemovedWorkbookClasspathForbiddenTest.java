...
/**
 * Regression: removed single-sheet workbook must not ship under {@code src/main/resources/evaluation/}.
 *
 * <p>(Stale copies could linger under {@code target/classes}; CI runs {@code clean} first.)
 */
class EvaluationRemovedWorkbookClasspathForbiddenTest {

    @Test
    void evaluation_dataset_xlsx_must_not_exist_under_main_evaluation_resources() {
        Path mainEvalRemovedWorkbook =
