...
class KnowledgeVectorMetadataBackfillServiceTest {
    ...
    @InjectMocks
    private KnowledgeVectorMetadataBackfillService service;
    ...
    void backfillProject_updatesVectorsWhenProjectExists() {
        ...
        when(knowledgeIndexSnapshotService.ensureBootstrapSnapshotForProject(project)).thenReturn(snap);
