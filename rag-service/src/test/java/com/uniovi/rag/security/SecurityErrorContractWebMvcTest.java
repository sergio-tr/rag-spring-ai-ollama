...
import com.uniovi.rag.interfaces.rest.admin.AdminHealthController;
...
@WebMvcTest(controllers = { MeSummaryController.class, AdminHealthController.class, ApiErrorController.class })
...
class SecurityErrorContractWebMvcTest {
    ...
    void adminRoute_withUserToken_returnsJson403() throws Exception {
        ...
        mockMvc.perform(get("/api/v5/admin/health")
                ...
                .andExpect(jsonPath("$.path").value("/api/v5/admin/health"));
    }
