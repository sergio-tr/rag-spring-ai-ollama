...
@WebMvcTest(controllers = MeSummaryController.class)
@ContextConfiguration(classes = RagWebMvcTestApplication.class)
@AutoConfigureMockMvc(addFilters = false)
@Import(MeSummaryController.class)
class MeSummaryControllerWebMvcTest {
    ...
    @Test
    void get_returnsSummary() throws Exception {
        when(meSummaryApplicationService.summarize(eq(userId)))
                .thenReturn(new MeSummaryResponse(1L, 2L, 3L, 4096L));

        mockMvc.perform(get(RagApiTestPaths.path("/me/summary")))
