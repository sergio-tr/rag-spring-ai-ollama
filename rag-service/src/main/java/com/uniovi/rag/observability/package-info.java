 ...
 *       {@code classify}/{@code classifyWithText} run in span {@code rag.classifier.classify}
 *       with input (query, modelId) and output (queryType). Subclasses implement
 ...
 *       {@code rag.retriever.retrieve} and {@code rag.retriever.createContext}.</li>
 * </ul>
