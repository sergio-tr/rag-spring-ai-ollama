...
/** Resolves deterministic-tool-first routing when full adaptive routing is off. */
@Service
public class DeterministicToolRoutingStrategy {

    private final DeterministicToolRoutingPolicy policy;
    private final RouteExecutionGateBuilder gateBuilder;

    public DeterministicToolRoutingStrategy(
            DeterministicToolRoutingPolicy policy, RouteExecutionGateBuilder gateBuilder) {
        this.policy = policy;
