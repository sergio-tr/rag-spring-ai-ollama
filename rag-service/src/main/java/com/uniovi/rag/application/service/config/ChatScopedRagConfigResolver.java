...
/**
 * Resolves {@link RagConfig} for chat-scoped requests using the same cascade as orchestrated chat execution.
...
public class ChatScopedRagConfigResolver {
    ...
    /**
     * Same resolution path as the main query pipeline for a {@link RagExecutionContext} overlay (including null overlay).
     */
