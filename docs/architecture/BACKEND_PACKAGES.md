...
| `interfaces.rest.dto.tracereplaybatch` | **P28:** bounded batch POST request/response DTOs for standalone replay batches; strict JSON (`ReplayBatchRestJacksonConfiguration`); static factories from P27 results; **no** dedicated mapper `@Service` bean. |
